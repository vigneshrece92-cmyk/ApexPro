...
export const DEFAULT_MTF_DATA: MTFAssetRow[] = [
  ...
  },
  {
    ...
    price: 7660.0,
    structures: {
      "15m": { bias: "bearish", detail: "Testing VAH (7,720) Supply Rejection", isBOS: true },
      "1h": { bias: "ranging", detail: "VWCB Volume Cluster at 7,650 POC", isBOS: false },
      "4h": { bias: "bearish", detail: "Bearish Mean Reversion to VAL (7,610)", isBOS: true },
      "1d": { bias: "ranging", detail: "Macro Range ₹7,550 - ₹7,850", isBOS: false },
    },
    overallBias: "SELL",
    confluenceScore: 82,
  },
  {
    ...
    price: 258.2,
    structures: {
      "15m": { bias: "bullish", detail: "VAL (254.1) Sweep & Bullish Rebound", isBOS: true },
      "1h": { bias: "bullish", detail: "Expanding to POC ₹260.0 Magnet", isBOS: false },
