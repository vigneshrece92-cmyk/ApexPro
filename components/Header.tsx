          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="flex items-center gap-1.5 font-bold tracking-tight text-white leading-none">
                <span className="text-base font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-400">
                  APEX<span className="text-gold">FX</span>
                </span>
                <span className="px-1.5 py-0.5 text-[9px] font-mono bg-blue-500/20 text-cyan-400 rounded border border-cyan-500/30">
                  PRO TERMINAL
                </span>
              </div>
              <p className="text-[10px] text-terminal-muted">Metals & Major FX Intelligence</p>
            </div>
          </div>
        ...
        <div className="flex items-center gap-2">
          ...
          {(onOpenDemoPanel || onOpenMT5Panel) && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-gradient-to-r from-emerald-950/70 to-teal-950/70 hover:from-emerald-900/80 hover:to-teal-900/80 text-emerald-300 border border-emerald-500/50 text-xs font-mono font-bold transition-all shadow-md shadow-emerald-500/10"
              title="ApexFX Internal Demo Broker ($3,000) • 100% Vercel Ready • 4H PO3 Auto-Bot"
            >
              <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
              <Zap className="w-3.5 h-3.5 text-emerald-400" />
              <span>Demo: ${(demoBalance ?? mt5Balance ?? 3000.0).toLocaleString("en-US", { minimumFractionDigits: 2 })}</span>
            </button>
          )}
          ...
          {onOpenAlertsHub && (
            <button
              ...
              className="relative flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-md bg-gradient-to-r from-amber-500/20 to-orange-500/20 hover:from-amber-500/30 hover:to-orange-500/30 text-amber-300 border border-amber-500/40 transition-all shadow-md shadow-amber-500/10"
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-md bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white shadow-md shadow-blue-500/20 transition-all border border-blue-400/30"
          >
            <Camera className="w-3.5 h-3.5 text-cyan-300" />
            <span>AI Chart Scanner</span>
